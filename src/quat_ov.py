...
class Quaternion:
    ...
    @classmethod
    def from_axis_angle(cls, axis_angle) -> "Quaternion":
...
class Vector3:
    ...
    @classmethod
    def cross_product(cls, v1: "Vector3", v2: "Vector3") -> "Vector3":
        return cls(
    ...
    @classmethod
    def dot_product(cls, v1: "Vector3", v2: "Vector3") -> float:
        return (
            (v1.x * v2.x) +
            (v1.y * v2.y) +
            (v1.z * v2.z)
    ...
    @classmethod
    def cosine_between(cls, v1: "Vector3", v2: "Vector3") -> float:
        return (
